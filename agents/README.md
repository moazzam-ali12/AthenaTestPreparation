...
> **Migration in progress:** this service is being migrated from ACT test-prep to CPA exam-prep (accounting/auditing/tax/regulation content for working professionals). References below to "SAT"/"ACT" describe the current directory layout, module names, and DB tables, which are being updated in a later phase of this migration — they do not reflect the product's target audience.
