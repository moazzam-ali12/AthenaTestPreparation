...
import { QuestCanvasScreen } from "./quest-canvas-screen";
...
export function QuestProblemPageContent() {
  ...
  const asProblem = {
    ...
    conceptTags: currentProblem.conceptTags,
    optionHints: currentProblem.optionHints,
          ...
          >
            ...
            {(questionPhase === "hint" || questionPhase === "hint2" || questionPhase === "tutor") && currentProblem.hint && (() => {
              const selectedOption =
                ctx.answers.get(currentProblem.id) ?? currentProblem.selectedOption ?? undefined;
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm text-muted-foreground">
                    <MathContent content={optionHint?.hint ?? currentProblem.hint} />
                  </div>
                </motion.div>
              );
            })()}
