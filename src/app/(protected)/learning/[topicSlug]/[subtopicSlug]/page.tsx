        ...
        {problems.length > 0 ? (
          <button onClick={() => router.push(`/learning/${params.topicSlug}/${params.subtopicSlug}/quiz`)} className="block text-left w-full">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-4">{problems.length} questions — CPA Exam-style practice</p>
      ...
      >
        ...
        <motion.div variants={fadeUp} className="border bg-card">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1.5">On the CPA Exam</h4>
              <p className="text-sm text-muted-foreground">{subtopic.conceptualOverview.actContext}</p>
            </div>
          </div>
        </motion.div>
